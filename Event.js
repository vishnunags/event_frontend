document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchEvents() {
        try {
            const response = await fetch('http://ec2-34-205-29-69.compute-1.amazonaws.com:3002/api/events'); // Adjust URL if necessary
            if (!response.ok) {
    ...
    async function handleRegistration(eventName) {
        ...
        try {
            const response = await fetch('http://ec2-34-205-29-69.compute-1.amazonaws.com:3002/api/register', { // Adjust URL if necessary
                method: 'POST',
                headers: {
